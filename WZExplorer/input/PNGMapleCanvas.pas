...
uses Windows, Classes, SysUtils, WZReader, {$IFDEF IMAGING}PNGImage, Graphics, {$ENDIF} ZLib;
...
type
  ...
  private
    ...
    {$ENDIF}
  public
    constructor Create(Width, Height, DataLength: Integer; Offset: Int64; Format: Integer; WZReader: TWZReader);
...
constructor TPNGMapleCanvas.Create(Width, Height, DataLength: Integer; Offset: Int64; Format: Integer; WZReader: TWZReader);
begin
  FHeight := Height;
  FWidth := Width;
